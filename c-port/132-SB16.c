...
static const char mProductName[] = "Sound Blaster 1.50 / 2.00";
...
static const char mError1[] = "Error 0001: Sound card  does not exist at the I/O address specified.";
